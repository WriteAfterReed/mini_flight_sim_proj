/**
 * @file A simple WebGL example drawing
 */
// Here is what you do, you create a function which pulls the values for the  L ambietent and set them based off of height.
...
/** @global list for storing keypresses */
var currentlyPressedKeys = {};
/** @global speed which we scale our view vector by */
var speed = 0.001;
/** @global vector used for updating view vector */
var newViewDir = vec3.create();
/** @global quat used for doing rotations */
...
function setupBuffers() {
    myTerrain = new Terrain(256,-0.5,0.5,-0.5,0.5); // CALLS TERRARN
...
function draw() { 
    ...
    mat4.perspective(pMatrix,degToRad(45), 
                     ...
                     0.1, 200.0);
    //scale view direction and add to eye pt
    // We want to look down -z, so create a lookat point in that direction
    vec3.scaleAndAdd(eyePt, eyePt, viewDir, speed);
    vec3.cross(newViewDir, up, viewDir);   
    vec3.add(viewPt, eyePt, viewDir);
    // Then generate the lookat matrix and initialize the MV matrix to that view
    mat4.lookAt(mvMatrix,eyePt,viewPt,up);
    //Draw Terrain
    mvPushMatrix();
    vec3.set(transformVec,0,-0.25,-1.5);   
    ...
    { 
      ...
      {
        gl.uniform1f(shaderProgram.uniformfogDensity, 1.0);
      }
      else{
...
//----------------------------------------------------------------------------------
/**
 * @param {event} event for interactions
 */
...
//----------------------------------------------------------------------------------
/**
 * Provides interactions for piloiting the plane from the keyboard.
 */
function handleKeys() {

  if (currentlyPressedKeys["ArrowUp"]){
    //Up arrow key
    quat.setAxisAngle(tempQuat, newViewDir, -degToRad(.15));
  ...
  if (currentlyPressedKeys["ArrowLeft"]){
    //Left arrow key
    quat.setAxisAngle(tempQuat, viewDir, -degToRad(.15));
